...
const posts = {
  "billbook-pro-architecture": {
    ...
    subtitle:
      "How I designed a proprietary .billbook file format, AWS RDS MySQL schema, and React Native offline-first architecture for billing at scale.",
  ...
  INDEX idx_status   (status, created_at)
      ...
      },
      {
        type: "stats",
        items: [
          { value: "< 40ms", label: "Avg API latency" },
          { value: "99.97%", label: "Uptime SLA" },
          { value: "$38/mo", label: "AWS infra cost" },
          { value: "500+", label: "Active SMBs" },
        ],
      },
    ],
    relatedSlugs: ["mysql-gst-schema", "react-native-truecaller-sdk"],
  },
  ...
  "nextjs-gsap-portfolio": {
    ...
    subtitle:
      "Deep dive into integrating GSAP ScrollTrigger with React and Next.js. Patterns that actually work without hydration issues.",
...
export default function AnimatedSection() {
    ...
    <section ref={container}>
      ...
      },
      {
        ...
        items: [
          ...
          { value: "0ms", label: "Layout shift" },
          { value: "~18kb", label: "GSAP gzip bundle" },
          { value: "100", label: "Lighthouse perf" },
        ],
      },
    ],
    relatedSlugs: ["billbook-pro-architecture", "react-native-truecaller-sdk"],
  },
  ...
  "react-native-truecaller-sdk": {
    ...
    subtitle:
      "Building a smooth spring-physics bottom sheet with PanResponder for phone authentication — no third-party libraries.",
...
const panResponder = PanResponder.create({
  ...
  onPanResponderRelease: (_, { dy, vy }) => {
    ...
    relatedSlugs: ["nextjs-gsap-portfolio", "mysql-gst-schema"],
  },
  ...
  "mysql-gst-schema": {
    ...
    title:
      "MySQL Schema Design for GST Billing: Triggers, Views & Calculations",
    subtitle:
      "Complete walkthrough of a production-ready MySQL schema with CGST/SGST/IGST logic, triggers, and views for Indian billing software.",
...
DELIMITER ;`,
      },
      {
        type: "stats",
        items: [
          { value: "3", label: "GST components" },
          { value: "100%", label: "Audit coverage" },
          { value: "0", label: "Calc errors in prod" },
          { value: "10+", label: "Views & procedures" },
        ],
      },
    ],
    relatedSlugs: ["billbook-pro-architecture", "nextjs-gsap-portfolio"],
  },
};
...
export default function BlogPostPage() {
  ...
  return (
    <div style={{ background: "var(--bg)", minHeight: "100vh" }}>
      <ProgressBar accent={post.accent} />
      ...
      >
        ...
        <div
          ...
          `,
            ...
            pointerEvents: "none",
            maskImage:
              "linear-gradient(180deg, transparent, rgba(0,0,0,0.6) 30%, rgba(0,0,0,0.6) 70%, transparent)",
          }}
        />
      ...
      {/* ── Article body ──────────────────────────────────────────────────── */}
      <article
        style={{ maxWidth: 800, margin: "0 auto", padding: "72px 28px 120px" }}
      >
        <TableOfContents sections={post.sections} accent={post.accent} />
        ...
        {post.sections.map((section, idx) => {
          ...
          if (section.type === "stats")
            return (
              <StatsRow key={idx} items={section.items} accent={post.accent} />
            );
        ...
        >
          ...
          <div style={{ flex: 1 }}>
            ...
            >
              Full-stack developer from Agartala, India. I build
              high-performance web and mobile products for ambitious businesses.
            </p>
